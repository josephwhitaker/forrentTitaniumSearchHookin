...
/**
 The base class for all PlayItem2 modules
 */
...
/**
 PlayItem2 Platform calls this method on startup.
 */
-(void)startup;

/**
 PlayItem2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 PlayItem2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 PlayItem2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 PlayItem2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
