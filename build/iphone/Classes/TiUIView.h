...
/**
 Base class for all PlayItem2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PlayItem2 view hierarchy (such as wrapped iOS UIViews) was touched.
