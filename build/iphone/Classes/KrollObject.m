...
//@interface PlayItem2Object : NSObject
//@end

@interface PlayItem2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PlayItem2Object class]])
		{
			for (NSString *key in [[(PlayItem2Object*)o modules] allKeys])
			{
