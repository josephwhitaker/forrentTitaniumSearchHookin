...
@interface PlayItem2Object : KrollCoverageObject {
#else
@interface PlayItem2Object : KrollObject {
#endif
@private
...
extern NSString * PlayItem2$ModuleRequireFormat;
