...
// in simulator we redefine to format for PlayItem2 Developer console
...
{\
	NSString * exceptionName = [@"org.playitem2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.playitem2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPlayItem2NativeItemNone = -1, 
	UIPlayItem2NativeItemSpinner = -2,
	UIPlayItem2NativeItemProgressBar = -3,
	
	UIPlayItem2NativeItemSlider = -4,
	UIPlayItem2NativeItemSwitch = -5,
	UIPlayItem2NativeItemMultiButton = -6,
	UIPlayItem2NativeItemSegmented = -7,
	
	UIPlayItem2NativeItemTextView = -8,
	UIPlayItem2NativeItemTextField = -9,
	UIPlayItem2NativeItemSearchBar = -10,
	
	UIPlayItem2NativeItemPicker = -11,
	UIPlayItem2NativeItemDatePicker = -12,
	
	UIPlayItem2NativeItemInfoLight = -13,
	UIPlayItem2NativeItemInfoDark = -14,
	
	UIPlayItem2NativeItemDisclosure = -15,
	
	UIPlayItem2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PlayItem2 instances of
